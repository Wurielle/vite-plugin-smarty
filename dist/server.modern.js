...
import require$$0$3, { join as join$2, resolve as resolve$4 } from 'path';
import util from 'util';
import tty from 'tty';
import require$$2$1 from 'net';
...
var jsmart = createCommonjsModule(function (module) {
(function (factory) {
          ...
          if (findInArray(params, 'nofilter') < 0) {
            ...
            if (this.tplModifiers.length) {
              ...
              if (typeof window === 'object' && window.document) {
                ...
                commonjsGlobal.__t = function () { return res };
              }
...
function getDecoder (encoding) {
  ...
  try {
    return lib$3.getDecoder(encoding)
  } catch (e) {
...
function read (req, res, next, parse, debug, options) {
  ...
  if (opts.encoding === null && encoding !== null && !lib$3.encodingExists(encoding)) {
...
var debug$b = src$4('body-parser:json');
...
var debug$a = src$4('body-parser:raw');
...
var debug$9 = src$4('body-parser:text');
...
var src$3 = functionBind.call(Function.call, Object.prototype.hasOwnProperty);
...
var getBaseIntrinsic = function getBaseIntrinsic(name, allowMissing) {
	...
	var alias;
	if (src$3(LEGACY_ALIASES, intrinsicName)) {
		alias = LEGACY_ALIASES[intrinsicName];
		intrinsicName = '%' + alias[0] + '%';
	}

	if (src$3(INTRINSICS, intrinsicName)) {
...
var getIntrinsic = function GetIntrinsic(name, allowMissing) {
	...
	for (var i = 1, isOwn = true; i < parts.length; i += 1) {
		...
		if (src$3(INTRINSICS, intrinsicRealName)) {
...
var decode$3 = function (str, decoder, charset) {
...
var stringify$2 = function stringify(
    ...
    var step = 0;
    var findFlag = false;
    while ((tmpSc = tmpSc.get(sentinel$1)) !== void undefined && !findFlag) {
    ...
    if (isNonNullishPrimitive$1(obj) || utils$2.isBuffer(obj)) {
        if (encoder) {
    ...
    for (var j = 0; j < objKeys.length; ++j) {
        ...
        valueSideChannel.set(sentinel$1, sideChannel$1);
...
var stringify_1$1 = function (object, opts) {
    ...
    for (var i = 0; i < objKeys.length; ++i) {
        ...
        pushToArray$1(keys, stringify$2(
            obj[key],
            key,
            generateArrayPrefix,
            commaRoundTrip,
...
var debug$8 = src$4('body-parser:urlencoded');
...
var resolve$1 = require$$0$3.resolve;
...
({
  templateDir: join$2(process.cwd(), 'public/components'),
  server: {
    port: 2222
  }
});
  ...
  return {
    ...
    config(config) {
      ...
      const getTemplate = name => {
        return readFileSync(resolve$4(process.cwd(), templateDir, name), {
          encoding: 'utf-8'
        });
      };
      ...
      app.post('/', async ({
        ...
        try {
          ...
          const output = await compiledTemplate.fetch(_data);
          res.send(output);
        } catch (e) {
          res.json({
            error: e.message,
