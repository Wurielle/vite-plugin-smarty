(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('fs'), require('jsmart'), require('path'), require('express'), require('util'), require('tty'), require('net'), require('events'), require('stream'), require('zlib'), require('buffer'), require('string_decoder'), require('async_hooks'), require('querystring'), require('cors')) :
	typeof define === 'function' && define.amd ? define(['exports', 'fs', 'jsmart', 'path', 'express', 'util', 'tty', 'net', 'events', 'stream', 'zlib', 'buffer', 'string_decoder', 'async_hooks', 'querystring', 'cors'], factory) :
	(global = global || self, factory(global.vitePluginSmarty = {}, global.fs, global.jsmart, global.path, global.express, global.util, global.tty, global.net, global.events, global.stream, global.zlib, global.buffer, global.stringDecoder, global.asyncHooks, global.querystring, global.cors));
})(this, (function (exports, require$$1$1, JSmart, require$$0$2, express, util, tty, require$$2$1, require$$0$3, require$$1$2, Zlib, buffer, require$$1$3, require$$0$4, require$$3$1, cors) {
	function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

	var require$$1__default = /*#__PURE__*/_interopDefaultLegacy(require$$1$1);
	var JSmart__default = /*#__PURE__*/_interopDefaultLegacy(JSmart);
	...
	function destroyZlibStream (stream) {
	  if (typeof stream.destroy === 'function') {
	    ...
	    } else if (stream._destroy && stream._destroy !== require$$1__default$1["default"].Transform.prototype._destroy) {
	...
	function hasDestroy (stream) {
	  return stream instanceof require$$1__default$1["default"] &&
	...
	function getRawBody (stream, options, callback) {
	  ...
	  if (done) {
	    ...
	    return readStream(stream, encoding, length, limit, wrap$1(done))
	  }
	...
	function tryRequireAsyncHooks$1 () {
	  try {
	    return require$$0__default$2["default"]
	  } catch (e) {
	    return {}
	  }
	}
	...
	var debug$3 = src$1('body-parser:json');
	...
	var debug$2 = src$1('body-parser:raw');
	...
	var debug$1 = src$1('body-parser:text');
	...
	var debug = src$1('body-parser:urlencoded');
	...
	function urlencoded (options) {
	  ...
	  return function urlencodedParser (req, res, next) {
	    ...
	    // read
	    read_1(req, res, next, parse, debug, {
	      debug: debug,
	      encoding: charset,
	      inflate: inflate,
	      limit: limit,
	...
	function parser (name) {
	  ...
	  switch (name) {
	    case 'qs':
	      ...
	      break
	    case 'querystring':
	      mod = require$$3__default["default"];
	      break
	  }
	...
	const defaultOptions /*: Required<Options>*/ = {
	  templateDir: require$$0$2.join(process.cwd(), 'public/components'),
	  server: {
	    port: 2222
	  }
	};
	...
	const smartyServerPlugin = options => {
	  ...
	  return {
	    ...
	    config(config) {
	      ...
	      const getTemplate = name => {
	        return require$$1$1.readFileSync(require$$0$2.resolve(process.cwd(), templateDir, name), {
	          encoding: 'utf-8'
	        });
	      };
	      JSmart__default["default"].prototype.getTemplate = getTemplate;
	      app.post('/', async ({
	        body: {
	          file,
	          data = {}
	        ...
	        try {
	          ...
	          const compiledTemplate = new JSmart__default["default"](tpl);
	...
	exports.smartyServerPlugin = smartyServerPlugin;
